...
#ifndef wiseroutehohut_h
#define wiseroutehohut_h
 ...
 **/
class MIXIM_API WiseRouteHoHuT : public BaseNetwLayer
{
private:
	/** @brief Copy constructor is not allowed.
	 */
	WiseRouteHoHuT(const WiseRouteHoHuT&);
	/** @brief Assignment operator is not allowed.
	 */
	WiseRouteHoHuT& operator=(const WiseRouteHoHuT&);
